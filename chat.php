...
?>
<head style="background-color: #0abde3;">
    <meta charset="UTF-8">
...
$q1 = "select * from chat where adminemail='$un' and useremail='$sn'";
      ...
      echo "<table border='2' cellspacing='2' cellpadding='2' width='40%' align='center'>
      <tr><td>Inbox</td></tr>";
      $i=1;
        while($d=mysqli_fetch_assoc($r1)){
            echo "<tr>";
            echo "<td>".$i++.". Question : ".$d['question']."</td></tr>";
            echo "<tr>";
            echo "<td> Answer : ".$d['answer']."</td></tr>";
        }
