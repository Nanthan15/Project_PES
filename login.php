...
session_start();
    if(isset($_REQUEST['log'])){
        ...
        if($un=="admin" && $pa=="admin123"){
            header("location:dashboard.php");
        }

        
        $q = "select * from studentadmin where email='$un' and password='$pa'";
        $r = mysqli_query($db,$q);
                ...
                <div class="col-lg-12 login-form">
                    <form action="" method="post">
                        ...
                        <div class="col-lg-12 loginbttm">
                            ...
                            <div class="col-lg-6 login-btm login-button" style="margin-left: 65px;">
                                <button type="submit" class="btn btn-outline-primary" name="log" style="margin-left: 30px;">LOGIN</button>
...
<tr>
    ...
    <tr>
        <tr>
    <td colspan="2"><input type="submit" value="Login" name="log"></td>
</tr>
</table> 
</form>
</div> -->
