...
<body style="background-image: linear-gradient(to top ,#1A2980, #26D0CE);">
    ...
    echo "<h3 class='title1'>Computer Science branch Question paper</h3>";
    $q = "select * from service where servicename='QP' && branch='CS'"; //edited here
    ...
    while($d = mysqli_fetch_assoc($r)){
        ...
        echo "<h5 class='card-title'><b>Previous Question Paper</b></h5>";
    ...
    <?php
        ...
        echo "<h3 class='title1'>Electronic and communication branch Question paper</h3>";
        $q = "select * from service where servicename='QP' && branch='EC'"; //edited here
