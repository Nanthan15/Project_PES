...
<body style="background-image: linear-gradient(to top ,#1A2980, #26D0CE);">
    ...
    <td>Download</td></tr>-->
    <?php
        echo "<h3 class='title1'>Computer Science Branch</h3>";
        $q = "select * from service where servicename='notes'";
        $r = mysqli_query($db,$q);
        $i=1;
        while($d = mysqli_fetch_assoc($r)){
            ...
            echo "<h5 class='card-title'><b>E-Notes</b></h5>";
    ...
    <?php
        ...
        echo "<h3 class='title1'>Electronic and communication </h3>";
